...
func TestToolNamesAreMinimalMemoTools(t *testing.T) {
	want := []string{"memo_add_memory", "memo_search_memory", "memo_memory_stats"}
...
func TestMCPAddSearchAndStats(t *testing.T) {
	...
	input := strings.Join([]string{
		...
		`{"jsonrpc":"2.0","id":3,"method":"tools/call","params":{"name":"memo_search_memory","arguments":{"query":"SQLite memory"}}}`,
		`{"jsonrpc":"2.0","id":4,"method":"tools/call","params":{"name":"memo_memory_stats","arguments":{}}}`,
		"",
	}, "\n")
